...
public abstract class ResourceUtils {
     ...
     * @throws java.io.FileNotFoundException if the resource cannot be resolved to a file in the file system
     */
     ...
     * @return a corresponding File object
     * @throws java.io.FileNotFoundException if the URL cannot be resolved to a file in the file system
     */
